    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        <div className="footer-container footer-grid">
          ...
          <div className="footer-col footer-about">
            <h3>Giới Thiệu</h3>
            <p>
              Red Bean Beauty chuyên sản xuất các dòng mỹ phẩm chăm sóc da từ hạt đậu đỏ
              Việt Nam — nguyên liệu thiên nhiên giúp mang tới làn da mềm mại, sáng khỏe.
              Sản phẩm không chứa Sulfate, Paraben hay Alcohol, phù hợp cho mọi loại da.
            </p>
          </div>
          ...
          {/* Column 4 — Theo dõi & Sản phẩm nổi bật */}
          <div className="footer-col">
        ...
        <div className="footer-container newsletter-grid">
          ...
          <div className="newsletter-form-wrap">
            ...
            <form className="newsletter-form" onSubmit={(e) => e.preventDefault()}>
              <input type="email" placeholder="Nhập địa chỉ email" aria-label="Email đăng ký nhận tin" />
          ...
          <div className="newsletter-contact">
            ...
            <div>
              ...
              <a href="tel:19006750" className="contact-value">19006750</a>
            </div>
          </div>
          ...
          <div className="newsletter-contact">
            ...
            <div>
              ...
              <a href="mailto:support@redbean.vn" className="contact-value">support@redbean.vn</a>
            </div>
          </div>
      ...
      <div className="footer-copyright">
        <div className="footer-container">
          <p>© 2026 Bản quyền thuộc về <strong>Red Bean Beauty</strong></p>
        </div>
      </div>
    </footer>
  )
